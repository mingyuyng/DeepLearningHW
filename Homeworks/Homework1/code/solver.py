...
if __name__ == '__main__':
  ...
  data = {
      ...
      'X_val': test_data,  # validation data
      'y_val': test_tar  # validation labels
  }

  model = log.LogisticClassifier(input_dim=D, hidden_dim=2 * D, reg=0.0)
  ...
  solver = Solver(model, data,
                  ...
                  lr_decay=1,
                  num_epochs=2000, batch_size=700,
                  print_every=1)
  solver.train()
